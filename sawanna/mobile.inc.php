...
class Mobile_Detect {
    ...
    public function __construct() {
        ...
        if (!self::CHECK_UA_ONLY && (isset($_SERVER['HTTP_X_WAP_PROFILE']) || isset($_SERVER['HTTP_PROFILE']))) {
            $this->isMobile = true;
        } elseif (!self::CHECK_UA_ONLY && (strpos($this->accept,'text/vnd.wap.wml') > 0 || strpos($this->accept,'application/vnd.wap.xhtml+xml') > 0)) {
            $this->isMobile = true;
        } else {
