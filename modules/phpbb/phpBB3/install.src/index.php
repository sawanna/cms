...
// sawanna
include($phpbb_root_path . 'includes/functions_sawanna.' . $phpEx);
sawanna_init();
if (!isset($sawanna) || !is_object($sawanna) || !method_exists($sawanna,'has_access')) {
	die('Sawanna not found');
}
if (!$sawanna->has_access('su')) {
	die('Sawanna: Permission denied');
}
