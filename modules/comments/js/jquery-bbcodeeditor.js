(function($) {
	...
	{	
		...
		if(options.code != false) options.code.click(function() {print_bbc('','[code]','[/code]',true)});
	...
	{
		if(increase) print_bbc('','[size=16]','[/size]');
		else print_bbc('','[size=10]','[/size]');
	}
